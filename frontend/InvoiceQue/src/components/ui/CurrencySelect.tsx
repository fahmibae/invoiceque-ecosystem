...
export default function CurrencySelect({
  ...
  const filtered = useMemo(() => {
    ...
    if (!q) {
      ...
      const popular = POPULAR_CURRENCIES.map((code) =>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="currency-select-name hide-mobile">
          {selected.name}
        </span>
        <svg
          className="currency-select-chevron"
          width="12"
          height="12"
          viewBox="0 0 12 12"
          fill="none"
      ...
      {open && (
        <div className="currency-select-dropdown">
          ...
          <div className="currency-select-search-wrap">
            <svg
              className="currency-select-search-icon"
              width="14"
              height="14"
              viewBox="0 0 14 14"
              fill="none"
            ...
            {search && (
              <button
                type="button"
                className="currency-select-clear"
                onClick={() => setSearch("")}
              >
                ✕
              </button>
