...
import {
  ArrowRight01Icon, ArrowLeft01Icon, Cancel01Icon,
  CheckmarkCircle02Icon, RocketIcon,
...
export default function TourGuide({
  ...
  return createPortal(
    <div className="tour-guide-overlay" style={{ position: 'fixed', inset: 0, zIndex: 9999 }}>
      ...
      >
        ...
        <rect
          x="0" y="0" width="100%" height="100%" fill="rgba(15, 23, 42, 0.75)"
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <span style={{ fontSize: 11, fontWeight: 700, color: 'var(--text-tertiary, #94a3b8)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
          ...
          {/* Content */}
          <h4 style={{ fontSize: 16, fontWeight: 800, color: 'var(--text-primary, white)', margin: '0 0 6px', lineHeight: 1.3 }}>
            {step.title}
          </h4>
          <p style={{ fontSize: 13, color: 'var(--text-secondary, #cbd5e1)', margin: '0 0 16px', lineHeight: 1.6 }}>
            {step.description}
          </p>

          {/* Progress bar */}
          <div style={{ height: 3, background: 'var(--bg-secondary, rgba(255,255,255,0.05))', borderRadius: 99, marginBottom: 16, overflow: 'hidden' }}>
            <div
              style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8 }}>
            <button
              onClick={skipTour}
              style={{
                fontSize: 12, fontWeight: 600, color: 'var(--text-tertiary, #94a3b8)',
              ...
              {currentStep > 0 && (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 10, border: '1px solid var(--border-color, rgba(255,255,255,0.1))',
                    background: 'transparent', color: 'var(--text-primary, white)',
