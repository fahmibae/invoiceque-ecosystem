      ...
      <div className="bg-bg-card border-2 rounded-xl p-5 border-blue-500 shadow-[0_0_0_3px_rgba(59,130,246,0.15)] bg-gradient-to-br from-blue-50 to-blue-100/50 dark:from-blue-900/20 dark:to-blue-800/10 mt-5">
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div>
              ...
              <div className="text-[13px] text-text-tertiary">
                Pembayaran internasional aktif
              </div>
            </div>
          </div>
          <button
        ...
        <div className="flex flex-col gap-3">
          <div className="flex justify-between items-center text-sm">
            ...
            <span className="inline-block py-1 px-2.5 rounded-full text-xs font-bold bg-blue-500/10 text-blue-600">
              ✓ Active
            </span>
          </div>
          <div className="flex justify-between items-center text-sm">
    ...
    <div className="bg-bg-card border-2 rounded-xl p-5 border-border-color mt-5">
      <div className="flex items-center gap-3.5 mb-5 pb-4 border-b border-border-light">
        ...
        <div>
          ...
          <div className="text-[13px] text-text-tertiary">
            Terima pembayaran internasional (USD, EUR, GBP, dll)
          </div>
        </div>
      </div>
      ...
      <div className="mb-4 p-3 bg-blue-500/5 border border-blue-500/20 rounded-lg">
        <div className="text-[13px] text-blue-700 dark:text-blue-400 leading-relaxed">
          💡 Cukup masukkan email PayPal Anda. Tidak perlu daftar PayPal
          Developer — pembayaran akan langsung masuk ke akun PayPal Anda.
        </div>
      </div>
      ...
      <form onSubmit={handleConnect}>
        ...
        {error && (
          <div className="flex items-center gap-2 text-red-500 text-[13px] mb-3">
            <Alert01Icon size={16} /> {error}
          </div>
        )}
        <button
          type="submit"
          className="flex items-center gap-2 btn btn-primary !bg-blue-600 hover:!bg-blue-700"
          disabled={submitting}
        >
          {submitting ? (
            "Menghubungkan..."
            ...
            <>
              <Link04Icon size={16} /> Hubungkan PayPal
            </>
          )}
        </button>
      </form>
