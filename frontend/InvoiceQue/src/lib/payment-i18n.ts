...
const translations: Record<PaymentLocale, PaymentTranslations> = {
  ...
  id: {
    ...
    paypalRedirectNotice:
      "Anda akan diarahkan ke PayPal untuk menyelesaikan pembayaran dengan aman.",
    payWithPaypal: "Bayar dengan PayPal",
    processing: "Memproses...",
    xenditRedirectNotice:
      "Anda akan diarahkan ke portal pembayaran Xendit untuk memilih metode pembayaran (Transfer Bank, Virtual Account, e-Wallet, dll).",
    ...
    verifyingPaypalPayment:
      "Mohon tunggu, kami sedang memverifikasi pembayaran PayPal Anda.",
    paymentSuccessful: "Pembayaran Berhasil!",
    thankYouPaymentAccepted: "Terima kasih! Pembayaran Anda telah diterima.",
    emailConfirmationNotice:
      "✉️ Konfirmasi pembayaran akan dikirim melalui email. Anda dapat menutup halaman ini.",
    errorOccurred: "Terjadi Kesalahan",
    cannotVerifyPayment:
      "Tidak dapat memverifikasi pembayaran. Silakan hubungi penjual.",
    backToPaymentPage: "← Kembali ke Halaman Pembayaran",
    paymentCancelled: "Pembayaran Dibatalkan",
    paymentCancelledNotice:
      "Anda telah membatalkan proses pembayaran PayPal. Tidak ada tagihan yang dikenakan.",
    verifyingPayment: "Memverifikasi Pembayaran...",
    verifyingYourPayment:
      "Mohon tunggu, kami sedang memverifikasi pembayaran Anda.",
    paymentExpired: "Pembayaran Kedaluwarsa",
    paymentExpiredNotice:
      "Link pembayaran ini sudah kedaluwarsa. Silakan hubungi penjual untuk mendapatkan link baru.",
    cannotVerifyContactSeller:
      "Tidak dapat memverifikasi pembayaran. Silakan hubungi penjual.",
  },
  ...
  en: {
    ...
    xenditRedirectNotice:
      "You will be redirected to the Xendit payment portal to select a payment method (Bank Transfer, Virtual Account, e-Wallet, etc.).",
    ...
    verifyingPaypalPayment:
      "Please wait, we are verifying your PayPal payment.",
    paymentSuccessful: "Payment Successful!",
    thankYouPaymentAccepted: "Thank you! Your payment has been received.",
    emailConfirmationNotice:
      "✉️ A payment confirmation will be sent via email. You can close this page.",
    errorOccurred: "An Error Occurred",
    cannotVerifyPayment: "Unable to verify payment. Please contact the seller.",
    backToPaymentPage: "← Back to Payment Page",
    paymentCancelled: "Payment Cancelled",
    paymentCancelledNotice:
      "You have cancelled the PayPal payment process. No charges have been applied.",
    ...
    cannotVerifyContactSeller:
      "Unable to verify payment. Please contact the seller.",
  },
  ...
  ar: {
    ...
    xenditRedirectNotice:
      "سيتم إعادة توجيهك إلى بوابة الدفع Xendit لاختيار طريقة الدفع (تحويل بنكي، حساب افتراضي، محفظة إلكترونية، إلخ).",
    ...
    emailConfirmationNotice:
      "✉️ سيتم إرسال تأكيد الدفع عبر البريد الإلكتروني. يمكنك إغلاق هذه الصفحة.",
    ...
    paymentCancelledNotice:
      "لقد ألغيت عملية الدفع عبر PayPal. لم يتم تحصيل أي رسوم.",
    ...
    paymentExpiredNotice:
      "انتهت صلاحية رابط الدفع هذا. يرجى الاتصال بالبائع للحصول على رابط جديد.",
  ...
  ms: {
    ...
    paypalRedirectNotice:
      "Anda akan diarahkan ke PayPal untuk melengkapkan pembayaran dengan selamat.",
    payWithPaypal: "Bayar dengan PayPal",
    processing: "Memproses...",
    xenditRedirectNotice:
      "Anda akan diarahkan ke portal pembayaran Xendit untuk memilih kaedah pembayaran (Pindahan Bank, Akaun Maya, e-Dompet, dll).",
    ...
    processingPayment: "Memproses Pembayaran...",
    verifyingPaypalPayment:
      "Sila tunggu, kami sedang mengesahkan pembayaran PayPal anda.",
    paymentSuccessful: "Pembayaran Berjaya!",
    thankYouPaymentAccepted: "Terima kasih! Pembayaran anda telah diterima.",
    emailConfirmationNotice:
      "✉️ Pengesahan pembayaran akan dihantar melalui e-mel. Anda boleh menutup halaman ini.",
    errorOccurred: "Ralat Berlaku",
    cannotVerifyPayment:
      "Tidak dapat mengesahkan pembayaran. Sila hubungi penjual.",
    backToPaymentPage: "← Kembali ke Halaman Pembayaran",
    paymentCancelled: "Pembayaran Dibatalkan",
    paymentCancelledNotice:
      "Anda telah membatalkan proses pembayaran PayPal. Tiada caj dikenakan.",
    verifyingPayment: "Mengesahkan Pembayaran...",
    verifyingYourPayment:
      "Sila tunggu, kami sedang mengesahkan pembayaran anda.",
    paymentExpired: "Pembayaran Tamat Tempoh",
    paymentExpiredNotice:
      "Pautan pembayaran ini telah tamat tempoh. Sila hubungi penjual untuk pautan baru.",
    cannotVerifyContactSeller:
      "Tidak dapat mengesahkan pembayaran. Sila hubungi penjual.",
  },
  ...
  zh: {
    ...
    processing: "处理中...",
    xenditRedirectNotice:
      "您将被重定向到 Xendit 支付门户，选择付款方式（银行转账、虚拟账户、电子钱包等）。",
  ...
  ja: {
    ...
    processing: "処理中...",
    xenditRedirectNotice:
      "Xendit決済ポータルに移動して、お支払い方法（銀行振込、バーチャル口座、電子ウォレットなど）を選択します。",
 ...
 */
export function getPaymentTranslations(
