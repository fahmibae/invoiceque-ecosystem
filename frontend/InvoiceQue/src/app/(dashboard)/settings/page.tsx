    ...
    <div className="animate-fade-in">
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="card">
          ...
          <p className="text-[13px] text-text-tertiary mb-4">
            Buat API keys untuk mengintegrasikan InvoiceQu dengan tools favorit Anda — VS Code, CI/CD pipeline, Zapier, dan lainnya.
          </p>
          <div className="p-4 rounded-xl border border-border-light bg-bg-main/30 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-semibold text-sm">Developer API Access</div>
                <div className="text-xs text-text-tertiary">Kelola API keys untuk integrasi eksternal</div>
              </div>
            </div>
            <Link
