...
const PRESET_PALETTES = [
  ...
  },
  {
    name: "Pastel Dream",
    colors: [
      { hex: "#FFB5E8", name: "Pink" },
      { hex: "#B5DEFF", name: "Sky" },
      { hex: "#E7FFAC", name: "Lime" },
      { hex: "#DCD3FF", name: "Lavender" },
      { hex: "#FFFFD1", name: "Cream" },
    ],
  },
  {
    name: "Corporate Pro",
...
export default function PalettesPage() {
  return (
    <PremiumGate feature="toolkit_palettes">
      <PalettesContent />
    </PremiumGate>
  );
}
...
function PalettesContent() {
  ...
  const addColor = () => {
    ...
    setForm((f) => ({
      ...
      colors: [
        ...f.colors,
        { hex: randomHex, name: `Color ${f.colors.length + 1}` },
      ],
    }));
  };
    ...
    <div className="max-w-6xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="text-center py-20 bg-bg-secondary rounded-2xl border border-border-color">
          ...
          >
            <Add01Icon width={16} height={16} /> {t("palettes.first")}
          </button>
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {palettes.map((palette) => {
            ...
            return (
              <div
                key={palette.id}
                className="bg-bg-secondary rounded-2xl border border-border-color overflow-hidden hover:shadow-lg transition-all duration-300 group"
              >
                {/* Color Swatches */}
                <div className="flex h-20">
                  {colors.map((color, idx) => (
                    <button
                      key={idx}
                      className="flex-1 relative group/swatch cursor-pointer transition-all hover:flex-[2]"
                ...
                <div className="p-4">
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <div className="relative">
                      <button
                        ...
                        onClick={() =>
                          setMenuOpen(
                            menuOpen === palette.id ? null : palette.id,
                          )
                        }
                      >
                  ...
                  <div className="flex flex-wrap gap-1">
                    {colors.map((c, i) => (
                      <span
                        key={i}
                        className="text-[10px] px-2 py-0.5 rounded-full bg-bg-hover text-text-tertiary"
                      >
                        {c.hex}
                      </span>
                    ))}
              ...
              <div className="flex items-center justify-between px-6 py-4 border-b border-border-light shrink-0">
                <h3 className="text-lg font-bold flex items-center gap-2">
                  <PaintBoardIcon
                    ...
                    className="text-violet-600"
                  />
                  {editingId ? t("palettes.editTitle") : t("palettes.createTitle")}
                </h3>
                <button
              ...
              <div className="overflow-y-auto flex-1 px-6 py-5 flex flex-col gap-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. Brand Colors - Client X"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder={t("palettes.descriptionPlaceholder")}
                    rows={2}
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <label className="block text-xs font-semibold text-text-tertiary uppercase tracking-[0.5px]">
                      {t("palettes.colors", { count: form.colors.length })}
                    </label>
                  ...
                  {showPresets && (
                    <div className="grid grid-cols-2 gap-2 mb-3">
                      {PRESET_PALETTES.map((p, i) => (
                        <button
                          key={i}
                          className="p-2 rounded-xl border border-border-color hover:border-violet-400 transition-all text-left"
                    ...
                    {form.colors.map((color, idx) => (
                      <div key={idx} className="flex items-center gap-2">
                        ...
                        <input
                          ...
                          placeholder={t("palettes.colorName")}
