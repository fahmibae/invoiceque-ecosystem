      ...
      <div className="page-header">
        <div className="page-header-left flex items-center gap-2">
          <div className="flex items-center gap-2">
            ...
            <h1 className="page-title">{t("quotationForm.createTitle")}</h1>
          </div>
          <p className="page-subtitle">{t("quotationForm.createSubtitle")}</p>
        </div>
      </div>
          ...
          <div className="card p-7">
            ...
            <div className="flex flex-col gap-2 mt-4">
              <button
                ...
                disabled={saving}
              >
                {saving ? t("common.saving") : t("invoiceForm.saveAndSend")}
              </button>
              <button
