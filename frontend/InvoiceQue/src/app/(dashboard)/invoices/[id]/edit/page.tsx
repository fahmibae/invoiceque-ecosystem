      ...
      <div className="page-header">
        <div className="page-header-left">
          <div className="flex items-center gap-2">
            ...
            <h1 className="page-title">{t("invoiceForm.editTitle")}</h1>
          </div>
          <p className="page-subtitle">{t("invoiceForm.editSubtitle")}</p>
        </div>
      </div>
            ...
            {items.map((item, index) => (
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <span className="text-xs font-bold text-red-600 bg-red-50 dark:bg-red-900/10 px-2.5 py-0.5 rounded-full">
                    #{index + 1}
                  </span>
                  {items.length > 1 && (
                    <button
                ...
                <div className="form-row">
                  ...
                  <div className="form-group">
                    <label className="form-label">{t("invoiceDetail.price")} (Rp)</label>
                    <input
                      type="number"
                      className="form-input"
                      min="0"
          ...
          <div className="card">
            ...
            <div className="form-group mt-4">
              ...
              <div className="flex gap-2">
                <button
                  type="button"
                  className={`btn flex-1 ${paymentType === "full" ? "btn-primary" : "btn-secondary"}`}
                  onClick={() => setPaymentType("full")}
                >
                  <MoneyBag01Icon /> {t("invoiceDetail.fullPayment")}
                </button>
                <button
                  type="button"
                  className={`btn flex-1 ${paymentType === "dp" ? "btn-primary" : "btn-secondary"}`}
        ...
        <div className="sticky top-[calc(var(--header-height)+24px)] max-lg:relative max-lg:top-0">
          <div className="card p-7">
            <div className="py-4 border-t border-border-color">
              ...
              <div className="flex justify-between py-1.5 text-[13px] text-text-secondary text-lg font-extrabold text-text-primary pt-3 mt-2 border-t-2 border-red-500">
            ...
            <div className="flex flex-col gap-2 mt-4">
              <button
                ...
                disabled={saving}
              >
                {saving ? t("common.saving") : t("invoiceForm.saveChanges")}
              </button>
              <button
